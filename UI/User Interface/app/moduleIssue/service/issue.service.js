...
var issueService = /** @class */ (function () {
    ...
    issueService.prototype.saveIssue = function (issue) {
        var bodyString = JSON.stringify(issue); // Stringify payload
    ...
    ;
    issueService.prototype.deleteIssue = function (issue) {
        var bodyString = JSON.stringify(issue); // Stringify payload
        var headers = new http_2.Headers({ 'Content-Type': 'application/json' }); // ... Set content type to JSON
        var options = new http_2.RequestOptions({ headers: headers }); // Create a request option
    ...
    ;
    ///////////////////// Details ///////////////////
    issueService.prototype.getIssueDetails = function () {
        return this._http.get('http://localhost:1065/api/IssueDetail/GetAllIssueDetails')
            .map(function (response) { return response.json(); });
    };
    ;
    issueService.prototype.getAllIssueDetailsByParentID = function (parentID) {
        return this._http.get("http://localhost:1065/api/IssueDetail/GetAllIssueDetailsByParentID?ID=" + parentID)
            .map(function (response) { return response.json(); });
    };
    ;
    issueService.prototype.saveIssueDetail = function (issueDetail) {
        var bodyString = JSON.stringify(issueDetail); // Stringify payload
        var headers = new http_2.Headers({ 'Content-Type': 'application/json' }); // ... Set content type to JSON
        var options = new http_2.RequestOptions({ headers: headers }); // Create a request option
    ...
    ;
    issueService.prototype.updateIssueDetail = function (issueDetail) {
        var bodyString = JSON.stringify(issueDetail); // Stringify payload
        var headers = new http_2.Headers({ 'Content-Type': 'application/json' }); // ... Set content type to JSON
        var options = new http_2.RequestOptions({ headers: headers }); // Create a request option
    ...
    ;
    issueService.prototype.deleteIssueDetail = function (issueDetail) {
        var bodyString = JSON.stringify(issueDetail); // Stringify payload
        var headers = new http_2.Headers({ 'Content-Type': 'application/json' }); // ... Set content type to JSON
        var options = new http_2.RequestOptions({ headers: headers }); // Create a request option
