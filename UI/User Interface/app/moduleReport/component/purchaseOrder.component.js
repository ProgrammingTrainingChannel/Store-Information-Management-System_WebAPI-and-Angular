...
var purchaseOrderComponent = /** @class */ (function () {
    ...
    ;
    purchaseOrderComponent.prototype.DeletePurchaseOrder = function () {
        var _this = this;
        if (confirm('Are you sure you want to delete this record?')) {
            this._purchaseOrderService.deletePurchaseOrder(this.purchaseOrder)
                .subscribe(function (result) {
    ...
    ;
    purchaseOrderComponent.prototype.DeletePurchaseOrderDetail = function () {
        var _this = this;
        if (confirm('Are you sure you want to delete this record?')) {
            this._purchaseOrderService.deletePurchaseOrderDetail(this.purchaseOrderDetail)
                .subscribe(function (result) {
                _this._alertService.success("Deleted Successfully");
            }, function (error) {
                _this._alertService.error("Delete failed");
