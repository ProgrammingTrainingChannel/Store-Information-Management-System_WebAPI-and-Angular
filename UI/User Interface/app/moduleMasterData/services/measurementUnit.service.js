...
var measurementUnitService = /** @class */ (function () {
    function measurementUnitService(_http) {
        this._http = _http;
    }
    ...
    ;
    measurementUnitService.prototype.saveMeasurementUnit = function (measurementUnit) {
        var bodyString = JSON.stringify(measurementUnit); // Stringify payload
    ...
    ;
    measurementUnitService.prototype.deleteMeasurementUnit = function (measurementUnit) {
        var bodyString = JSON.stringify(measurementUnit); // Stringify payload
        var headers = new http_2.Headers({ 'Content-Type': 'application/json' }); // ... Set content type to JSON
        var options = new http_2.RequestOptions({ headers: headers }); // Create a request option
